...
public class OrderServiceActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getData(currentPage);
        adapter = new SimpleAdapter(OrderServiceActivity.this, list, R.layout.list_order_service,
                new String [] {"name", "address", "orderDate", "orderTime", "serviceType"},
                new int [] {R.id.order_custom_name, R.id.order_location, R.id.order_date,
                        R.id.order_time, R.id.order_content});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.setClass(OrderServiceActivity.this, GrabOrderActivity.class);
    ...
    public void getData(int page)
    {
        ...
        volley_Post(getResources().getString(R.string.url_order_list), req);
    }
    ...
    private void volley_Post(String url_add, final Map<String,String> req)
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String s)
            {
                ...
                {
                    Toast.makeText(OrderServiceActivity.this, response.get("msg").toString(),
