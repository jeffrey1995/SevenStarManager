...
public class TrainInformationActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getData(currentPage);
        adapter = new SimpleAdapter(TrainInformationActivity.this, list, R.layout.list_train_information,
                new String [] {"typeName", "address", "startDate", "endDate"},
                new int [] {R.id.train_course_type, R.id.train_location,
                        R.id.train_start_date, R.id.train_end_date});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.setClass(TrainInformationActivity.this, SignUpActivity.class);
    ...
    public void getData(int page)
    {
        ...
        volley_Post(getResources().getString(R.string.url_train_information), req);
    }
    ...
    private void volley_Post(String url_add, final Map<String,String> req)
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String s)
            {
                ...
                {
                    Toast.makeText(TrainInformationActivity.this, response.get("msg").toString(),
