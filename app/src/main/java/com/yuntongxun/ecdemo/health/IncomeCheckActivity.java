...
public class IncomeCheckActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_income_check);
        ...
        getData(currentPage);
        adapter = new SimpleAdapter(IncomeCheckActivity.this, list, R.layout.list_income_check,
                new String [] {"baseSalary", "sarary", "realPay", "date"},
                new int [] {R.id.income_base_salary, R.id.income_salary,
                        R.id.income_real_salary, R.id.income_grant_date});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                intent.setClass(IncomeCheckActivity.this, IncomeDetailsActivity.class);
    ...
    public void getData(int page)
    {
        ...
        volley_Post(getResources().getString(R.string.url_income_check), req);
    }
    ...
    private void volley_Post(String url_add, final Map<String,String> req)
    {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String s)
            {
                ...
                {
                    Toast.makeText(IncomeCheckActivity.this, response.get("msg").toString(),
